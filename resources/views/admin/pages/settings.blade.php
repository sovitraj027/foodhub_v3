    ...
    <div role="tabpanel">
        ...
        <ul class="nav nav-tabs" role="tablist">
            ...
            <li role="presentation">
                <a href="#homepage_settings" aria-controls="homepage_settings" role="tab" data-toggle="tab">Home
                    Page Settings</a>
            </li>
        ...
        <div class="tab-content tab-content-default">
            ...
            <div role="tabpanel" class="tab-pane" id="homepage_settings">
                <form action="{{ url('admin/homepage_settings') }}" id="layout_settings_form"
                    name="layout_settings_form" enctype="multipart/form-data" method="POST"></form>
                @csrf
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <div class="media">
                            <div class="media-left">
                                ...
                                <img src="{{ URL::asset('upload/' . $settings->home_slide_image1) }}" alt="bg image"
                                    width="150">
                                @endif
                    ...
                    <div class="col-sm-9">
                        <div class="media">
                            <div class="media-left">
                                ...
                                <img src="{{ URL::asset('upload/' . $settings->home_slide_image2) }}" alt="bg image"
                                    width="150">
                                @endif
                    ...
                    <div class="col-sm-9">
                        <div class="media">
                            <div class="media-left">
                                ...
                                <img src="{{ URL::asset('upload/' . $settings->home_slide_image3) }}" alt="bg image"
                                    width="150">
                                @endif
                    ...
                    <div class="col-sm-9">
                        <div class="media">
                            <div class="media-left">
                                ...
                                <img src="{{ URL::asset('upload/' . $settings->page_bg_image) }}" alt="bg image"
                                    width="150">
                                @endif
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <input type="text" name="total_restaurant" value="{{ $settings->total_restaurant }}"
                            class="form-control" value="">
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <input type="text" name="total_people_served" value="{{ $settings->total_people_served }}"
                            class="form-control" value="">
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <input type="text" name="total_registered_users" value="{{ $settings->total_registered_users }}"
                            class="form-control" value="">
                    </div>
                </div>
            ...
            <div role="tabpanel" class="tab-pane" id="other_Settings">
                ...
                <form action="{{ url('admin/headfootupdate') }}" class="form-horizontal padding-15" id="pass_form"
                    method="POST" name="pass_form">
