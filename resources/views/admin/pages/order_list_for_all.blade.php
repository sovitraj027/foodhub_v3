                        ...
                        <td class="text-center">
                            <div class="btn-group">
                                ...
                                <ul class="dropdown-menu dropdown-menu-right" role="menu">
                                    <li><a
                                            href="{{ url('admin/restaurants/view/orderlist/'.$order->id.'/Pending') }}"><i
                                    ...
                                    <li><a
                                            href="{{ url('admin/restaurants/view/orderlist/'.$order->id.'/Cancel') }}"><i
                                                class="md md-cancel"></i> Cancel</a></li>
                                    <li><a
                                            href="{{ url('admin/restaurants/view/orderlist/'.$order->id) }}"><i
