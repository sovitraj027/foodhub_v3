    ...
    <div class="what-we-do">
        <div class="contact_block container">
            <div class="contact-form">
                <div class="col-sm-6">
                    <form action="{{ url('contact_send') }}" id="contact_form" enctype="multipart/form-data" method="POST" autocomplete="off">
                      @csrf
                        <div class="message">
                            @if (count($errors) > 0)
                ...
                <div class="col-sm-6">
                    ...
                    <div class="loc-info">
                        ...
                        <p><i class="fa fa-envelope-o"></i><a
                                href="mailto:{{ getcong_widgets('footer_widget3_email') }}">{{ getcong_widgets('footer_widget3_email') }}</a>
                        </p>
                    </div>
                </div>
            </div>
