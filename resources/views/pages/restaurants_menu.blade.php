    ...
    <div class="container">
      <div id="sub_content" class="animated zoomIn">
        <div class="col-md-2 col-sm-3">
          {{-- <div id="thumb"><img src="{{ URL::asset('upload/restaurants/'.$restaurant->restaurant_logo.'-b.jpg') }}"
        ...
        <div class="col-md-10 col-sm-9">
          ...
          <div class="rating">
            {{-- @for($x = 0; $x < 5; $x++) @if($x < $restaurant->review_avg)
              ...
              @endfor
              (<small><a href="{{URL::to('restaurants/'.$restaurant->restaurant_slug)}}"> Read
                  {{\App\Review::getTotalReview($restaurant->id)}} Reviews </a></small>)
          </div> --}}
          {{-- <div class="rstl_list_btn"><a href="{{URL::to('restaurants/'.$restaurant->restaurant_slug)}}">View
              Restaurant</a></div> --}}
        </div>
      </div>
    </div>
      ...
      <div class="col-md-9 col-sm-7 col-xs-12">
        <div id="main_menu" class="box_style_2">
          ...
          <table class="table table-striped cart-list">
            ...
            <tbody>
              @forelse($category->menus as $menu_item)
              <tr>
                <td>
                  <div class="rstl_img"><a href="#menu_{{$menu_item->id}}">
                      @if($menu_item->menu_image)
                      <img src="/storage/menu-image/{{ $menu_item->menu_image }}" />
