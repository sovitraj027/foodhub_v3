            ...
            <div class="col-md-6">
                <div class="box_style_2">
                    ...
                    <div id="confirm"> <i class="fa fa-check-square-o"></i>
                        <h3>Thank Your Order purchase From Esewa</h3>
                    ...
                    <table class="table table-striped nomargin">
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><strong
                                        class="pull-right">{{getcong('currency_symbol')}}{{$order_item->item_price}}</strong>
                                </td>
                            </tr>
                            @endforeach
                            ...
                            <tr>
                                ...
                                <td class="total_confirm"><span
                                        class="pull-right">{{getcong('currency_symbol')}}{{$price}}</span></td>
                            </tr>
