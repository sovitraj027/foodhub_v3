...
<header style="background: rgba(34, 11, 162, 0.29);box-shadow: 0 2px 10px -2px rgba(0, 0, 0, 0.41);display: inline-block;line-height: 0;position: relative;width: 100%;z-index: 999;margin-bottom:20px;">
...
<div style="width: 1100px;margin:0 auto;">    
<h2 style="color: #565656;font-size: 14px;font-weight: 600;padding:5px 10px;text-align:left;">Hi {{$data['name']}},</h2>
