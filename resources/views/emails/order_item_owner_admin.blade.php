...
<header style="background: rgba(47, 65, 164, 0.98);box-shadow: 0 2px 10px -2px rgba(0, 0, 0, 0.41);display: inline-block;line-height: 0;position: relative;width: 100%;z-index: 999;margin-bottom:20px;">
...
<p style="padding:0 10px;margin: 0 0 10px;line-height:22px;color:#444">New order placed by {{ucfirst($data['name'])}}!</p>
