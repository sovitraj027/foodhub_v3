...
<div class="sub-banner" style="background:url({{ URL::asset('upload/' . getcong('page_bg_image')) }}) no-repeat center top;">
    <div class="overlay">
        <div class="container">
            <h1>Package Added Sucessfully</h1>
        </div>
    </div>
</div>
        ...
        <div class="row">
            ...
            <div class="col-md-6">
                <div class="box_style_2">
                    <h2 class="inner">Package Confirmed</h2>
                    <div id="confirm"> <i class="fa fa-check-square-o"></i>
                        <h3>Thank you!</h3>
                    </div>
                    <h4>Summary</h4>
                   
                    <table class="table-striped nomargin table">
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><strong class="pull-right">{{ getcong('currency_symbol') }}{{ $order_item->item_price }}</strong>
                                </td>
                            </tr>
                            @endforeach
                            ...
                            <tr>
                                ...
                                <td class="total_confirm"><span class="pull-right">{{ getcong('currency_symbol') }}{{ $price = DB::table('cart')->where('user_id', Auth::id())->sum('item_price') }}</span>
                                </td>
                            </tr>
